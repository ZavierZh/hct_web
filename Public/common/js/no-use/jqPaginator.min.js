...
function(a) {
    ...
    a.jqPaginator = function(b, c) {
        ...
        d.init = function() {
            var b = d.options = a.extend({},
            a.jqPaginator.defaultOptions, c);
            if (!b.totalPages && !b.totalCounts) throw new Error("[jqPaginator] totalCounts or totalPages is required");
            if (!b.totalPages && b.totalCounts && !b.pageSize) throw new Error("[jqPaginator] pageSize is required");
            if (!b.totalPages && b.totalCounts && b.pageSize && (b.totalPages = Math.ceil(b.totalCounts / b.pageSize)), b.currentPage < 1 || b.currentPage > b.totalPages) throw new Error("[jqPaginator] currentPage is incorrect");
            if (b.totalPages < 1) throw new Error("[jqPaginator] totalPages cannot be less currentPage");
            d.extendJquery(),
            d.render(),
            d.fireEvent(this.options.currentPage)
        },
        ...
        d.getPages = function() {
            var a = [];
            var b = d.options.visiblePages;
            var c = d.options.currentPage;
            var e = d.options.totalPages;
            b > e && (b = e);
            var f = Math.floor(b / 2);
          console.log("-------------------\na:"+a+"\nb:"+b+"  c:"+c+"  e:"+e+"  h:"+h+"  g:"+g+"  f:"+f);
          ...
          console.log("1---\na:"+a+"\nb:"+b+"  c:"+c+"  e:"+e+"  h:"+h+"  g:"+g+"  f:"+f);
            ...
            var h = c + f;
            var end = c+f;
          console.log("2---\na:"+a+"\nb:"+b+"  c:"+c+"  e:"+e+"  h:"+h+"  g:"+g+"  f:"+f+"   end:"+end);
        ...
        d.fireEvent = function(a) {
            return "function" != typeof d.options.onPageChange || d.options.onPageChange(a) !== !1;
        },
